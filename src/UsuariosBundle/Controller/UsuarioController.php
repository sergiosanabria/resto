...
//        );
        ...
        return $this->render('UsuariosBundle:Usuario:index.html.twig',
            array(
                'entities' => $entities,
            ));
    }
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('UsuariosBundle:Usuario:new.html.twig',
            array(
                'entity' => $entity,
    ...
    public function newPersonaAction($id)
    {
        $entity = new Usuario();
    ...
    public function createPersonaAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('cliente_index', array('id' => $entity->getId())));
        }

        return $this->render('UsuariosBundle:Usuario:persona.html.twig',
            array(
                'entity' => $entity,
                'form' => $form->createView(),
            ));
    ...
    public function showAction($id)
    {
        ...
        return $this->render('UsuariosBundle:Usuario:show.html.twig',
            array(
                'entity' => $entity,
            ));
    }
    ...
    public function editAction($id)
    {
        ...
        return $this->render('UsuariosBundle:Usuario:edit.html.twig',
            array(
                'entity' => $entity,
